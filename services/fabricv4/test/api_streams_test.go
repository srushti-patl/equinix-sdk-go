...
func Test_fabricv4_StreamsApiService(t *testing.T) {
	...
	t.Run("Test StreamsApiService DeleteStreamAssetByUuid", func(t *testing.T) {
		...
		httpRes, err := apiClient.StreamsApi.DeleteStreamAssetByUuid(context.Background(), assetId, asset, streamId).Execute()
	...
	t.Run("Test StreamsApiService DeleteStreamByUuid", func(t *testing.T) {
		...
		httpRes, err := apiClient.StreamsApi.DeleteStreamByUuid(context.Background(), streamId).Execute()
