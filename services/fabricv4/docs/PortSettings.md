...
**ProductPart** | Pointer to **string** |  | [optional] 
...
`func (o *PortSettings) GetProductPart() string`

GetProductPart returns the ProductPart field if non-nil, zero value otherwise.

### GetProductPartOk

`func (o *PortSettings) GetProductPartOk() (*string, bool)`

GetProductPartOk returns a tuple with the ProductPart field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetProductPart

`func (o *PortSettings) SetProductPart(v string)`

SetProductPart sets ProductPart field to given value.

### HasProductPart

`func (o *PortSettings) HasProductPart() bool`

HasProductPart returns a boolean if a field has been set.
