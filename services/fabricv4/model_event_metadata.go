...
func (o *EventMetadata) GetHref() string {
...
func (o *EventMetadata) GetHrefOk() (*string, bool) {
	if o == nil || IsNil(o.Href) {
		return nil, false
	}
	return o.Href, true
...
func (o *EventMetadata) HasHref() bool {
	if o != nil && !IsNil(o.Href) {
		return true
	}
...
func (o *EventMetadata) SetHref(v string) {
	o.Href = &v
}

// GetType returns the Type field value if set, zero value otherwise.
func (o *EventMetadata) GetType() string {
...
// and a boolean to check if the value has been set.
func (o *EventMetadata) GetTypeOk() (*string, bool) {
	if o == nil || IsNil(o.Type) {
		return nil, false
	}
	return o.Type, true
...
func (o *EventMetadata) HasType() bool {
	if o != nil && !IsNil(o.Type) {
		return true
	}
...
func (o *EventMetadata) SetType(v string) {
	o.Type = &v
}

// GetUuid returns the Uuid field value if set, zero value otherwise.
func (o *EventMetadata) GetUuid() string {
...
// and a boolean to check if the value has been set.
func (o *EventMetadata) GetUuidOk() (*string, bool) {
	if o == nil || IsNil(o.Uuid) {
		return nil, false
	}
	return o.Uuid, true
...
func (o *EventMetadata) HasUuid() bool {
	if o != nil && !IsNil(o.Uuid) {
		return true
	}
...
func (o *EventMetadata) SetUuid(v string) {
	o.Uuid = &v
}
...
func (o *EventMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varEventMetadata)
