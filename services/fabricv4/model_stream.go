...
type Stream struct {
	...
	StreamSubscriptionCount *int32                 `json:"streamSubscriptionCount,omitempty"`
...
// GetStreamSubscriptionCount returns the StreamSubscriptionCount field value if set, zero value otherwise.
func (o *Stream) GetStreamSubscriptionCount() int32 {
	if o == nil || IsNil(o.StreamSubscriptionCount) {
		var ret int32
		return ret
	}
	return *o.StreamSubscriptionCount
}

// GetStreamSubscriptionCountOk returns a tuple with the StreamSubscriptionCount field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Stream) GetStreamSubscriptionCountOk() (*int32, bool) {
	if o == nil || IsNil(o.StreamSubscriptionCount) {
		return nil, false
	}
	return o.StreamSubscriptionCount, true
}
...
// SetStreamSubscriptionCount gets a reference to the given int32 and assigns it to the StreamSubscriptionCount field.
func (o *Stream) SetStreamSubscriptionCount(v int32) {
	o.StreamSubscriptionCount = &v
}
...
func (o Stream) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.StreamSubscriptionCount) {
		toSerialize["streamSubscriptionCount"] = o.StreamSubscriptionCount
	}
...
func (o *Stream) UnmarshalJSON(data []byte) (err error) {
	...
	*o = Stream(varStream)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "streamSubscriptionCount")
