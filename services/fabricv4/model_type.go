...
// List of Type
const (
	TYPE_TRANSACTION_STATUS_AUDIT Type = "TRANSACTION_STATUS_AUDIT"
	TYPE_RP_OPSTATUS_NOTIFICATION Type = "RP_OPSTATUS_NOTIFICATION"
	TYPE_RP_CONFIG_NOTIFICATION   Type = "RP_CONFIG_NOTIFICATION"
)
